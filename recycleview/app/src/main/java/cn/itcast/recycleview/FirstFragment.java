...
public class FirstFragment extends Fragment {
    ...
    private String[] name = {"徐州","古田","屏南","周宁","寿宁","福安","柘荣","福鼎","霞浦","其他"};
    private String[] name1 = {"徐州县","古田县","屏南县","周宁县","寿宁县","福安市","柘荣县","福鼎市","霞浦县"};
...
private String[] nametwo = {"回龙窝","戏马台","户部山","徐州博物馆","云龙山","宝莲寺",
    ...
    private String[] buy={"免费","免费","免费","免费","免费","免费",
    ...
    private String[] introduces = {"回龙窝是徐州的一个历史文化街区，整体还原清代徐州建筑，打造融时代休闲文化于一体的文商旅复合型体验式街区，凸显慢生活的功能定位。街区里有很多徐州民间工艺品展示、有特色的咖啡馆、茶社、著名的猫空书屋，著名民花间堂都非常吸引年轻人的目光。这里成为老徐州的底片，新城市的客厅。",
