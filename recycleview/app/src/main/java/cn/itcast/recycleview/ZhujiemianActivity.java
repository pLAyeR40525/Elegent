...
public class ZhujiemianActivity extends AppCompatActivity {
    ...
    //徐州市
    private String[] xuz = {"回龙窝","戏马台","户部山","徐州博物馆","云龙山","宝莲寺"};
    private int[] xzicons = {R.drawable.sanduao,R.drawable.huotongguzheng,R.drawable.shuili,R.drawable.senglin,R.drawable.yangzhong,R.drawable.shangjinbei};
    private String[] xzbuy = {"免费","免费","免费","免费","免费","免费"};
    private String[] xzintroduce = {"回龙窝是徐州的一个历史文化街区，整体还原清代徐州建筑，打造融时代休闲文化于一体的文商旅复合型体验式街区，凸显慢生活的功能定位。街区里有很多徐州民间工艺品展示、有特色的咖啡馆、茶社、著名的猫空书屋，著名民花间堂都非常吸引年轻人的目光。这里成为老徐州的底片，新城市的客厅。",
            "戏马台是徐州现存最早的古迹之一，公元前206年，盖世英雄项羽灭秦后，自立为西楚霸王，定都彭城，于城南里许的南山上，构筑崇台，以观戏马，故名戏马台。历代在台上营建了不少建筑物，诸如台头寺、三义庙、名宦祠、聚奎书院、耸翠山房、碑亭等。随着岁月的流逝，时移世变，昔日的建筑物已湮没殆尽。现经整修，戏马台以巍巍壮观，重光溢彩的面貌，迎接海内外游客。",
            ...
            "云龙山位于徐州市城南，既有自然风光，又有人文景观，徐州景观之首。山上文物古迹众多，有北魏时代的大石佛，唐宋摩崖石刻，宋代的放鹤亭，招鹤亭，饮鹤泉，张二人旧居，明代的兴化禅寺，清代的大士岩、碑廊等历史文物古迹。云龙山上的观台是欣赏落日的绝佳之地。",
            "宝莲寺位于江苏省徐州经济技术开发区蟠桃山麓，占地面积1100余亩。始建于南北朝时期刘宋永初年间，同为北魏永兴年间，原是中国第一座有印度风格的寺庙，其祖师法显大师也是历史上第一位西行取经归来的高僧。宝莲寺历经千余年几度兴废，先称龙华寺，后名洪峰寺、红莲寺，在清乾隆年间定名宝莲寺，于解放前夕荒废。2009年，徐州经济技术开发区决定重新修建蟠桃山历史文化景区，由香港金锋公司发起立项，江苏省宗教事务局批准重修，星云大师亲自题写寺名。重建后的宝莲寺内,八殿、两阁、一院，建筑特色显盛唐风格。"};

    //古田县
    private  String [] zhenj = {"古田钱来山景区","翠屏湖","齐云寺","古田溪山书画院","长洋徐氏古民居群","金钟湖山庄","凤林祠","蝉林祠","圆瑛故居","古田临水宫"};
    private int[] zjicons = {R.drawable.gutianxian,R.drawable.cuipinghu,R.drawable.qiyunshi,R.drawable.gutianxishan,R.drawable.changyangxunshi,R.drawable.jinzhonghushanzhuan,R.drawable.fenglinshi,R.drawable.changlinshi,R.drawable.yuanyinguju,R.drawable.gutianlinshuigong};
    private String[] zjbuy = {"¥44","¥80","¥68","免费","免费","免费","免费","免费","免费","免费"};
    private String[] zjintroduce = {"钱来山风景区位于福建省宁德市古田县大桥镇钱厝村，是福建首个“钱文化”主题旅游风景区。景区总面积666平方公里，以景区出入口为中心，由荷花梯田、樱花谷、820山谷、飞瀑谷、有钱谷和谷里农场6个片区组成，呈环状分布，游步道总长度约3.8公里。钱来山风景区平均海拔820米，夏季从早到晚均温27℃，是福州周边又一避暑胜地。",
    ...
    private String[] qitaname ={"古田县","屏南县","福鼎市","福鼎市","柘荣县","柘荣县","徐州区","徐州区","徐州区"};
    private String[] nametwo = {"回龙窝","戏马台","户部山","徐州博物馆","云龙山","宝莲寺",
    ...
    private String[] buytwo={"免费","免费","免费","免费","免费","免费",
    ...
    private String[] introducestwo = {"回龙窝是徐州的一个历史文化街区，整体还原清代徐州建筑，打造融时代休闲文化于一体的文商旅复合型体验式街区，凸显慢生活的功能定位。街区里有很多徐州民间工艺品展示、有特色的咖啡馆、茶社、著名的猫空书屋，著名民花间堂都非常吸引年轻人的目光。这里成为老徐州的底片，新城市的客厅。",
            "戏马台是徐州现存最早的古迹之一，公元前206年，盖世英雄项羽灭秦后，自立为西楚霸王，定都彭城，于城南里许的南山上，构筑崇台，以观戏马，故名戏马台。历代在台上营建了不少建筑物，诸如台头寺、三义庙、名宦祠、聚奎书院、耸翠山房、碑亭等。随着岁月的流逝，时移世变，昔日的建筑物已湮没殆尽。现经整修，戏马台以巍巍壮观，重光溢彩的面貌，迎接海内外游客。",
            "户部山位于徐州古城之南，又称南山。公元前206年，西楚霸王项羽定都彭城，曾在山顶建戏马台，而成为徐州的第一胜迹。作为“千古繁华地，徐州不夜城”，历史上曾有“穷北关，富南关，有钱都住户部山”的俗语。",
            "徐州博物馆是徐州市人民政府在清朝乾隆皇帝南巡时行宫旧址上建立起来的地方综合性博物馆。是国家4A级旅游景区。徐州博物馆建于1959年，坐落在云龙山北麓，历经三次改扩建，由陈列主楼、土山东汉彭城王墓、汉代采石场遗址、乾隆行宫及碑园四个展区组成。占地面积33000平方米，建筑面积12000平方米，展厅面积3000余平方米。并配有书吧、咖啡吧、纪念品商店等休闲服务区。徐州博物馆陈列主楼为主展区，常年陈列有“古彭之宝”、“金戈铁马”、“天工汉玉”、“俑偶华彩”、“明清家具”、“邓永清捐赠明清书画”等展览。",
            "云龙山位于徐州市城南，既有自然风光，又有人文景观，徐州景观之首。山上文物古迹众多，有北魏时代的大石佛，唐宋摩崖石刻，宋代的放鹤亭，招鹤亭，饮鹤泉，张二人旧居，明代的兴化禅寺，清代的大士岩、碑廊等历史文物古迹。云龙山上的观台是欣赏落日的绝佳之地。",
    ...
    private String[] dizhi ={"徐州","徐州","徐州","徐州","徐州","徐州","徐州","徐州","徐州",
...
//        }三都
        ...
        if(name_receive.equals("徐州")){
            name = xuz;
            icons = xzicons;
            buy = xzbuy;
            introduces = xzintroduce;
        }
        if(name_receive.equals("镇江")){
            name = zhenj;
            icons = zjicons;
            buy = zjbuy;
            introduces = zjintroduce;
        }
...
//                StaggeredGridLayoutManager.VERTICAL));三都
